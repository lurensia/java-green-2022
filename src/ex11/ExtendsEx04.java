...
// hp = 100;
// atk = 50;
// 꼭 protosunit 으로 추상화해야해
class Darktempler extends ProtossUnit { // 특수 공격
    String name = "다크템플러";
    int hp = 100;
    int attack = 50;
...
public class ExtendsEx04 {
    ...
    static void attack(ProtossUnit u1, ProtossUnit u2) {
        ...
        System.out.println(u2 + " 가 " + u1 + "한테 공격받았습니다." + u2.getHp());
    }

    public static void main(String[] args) {
        ProtossUnit z1 = new Zealot();
        ProtossUnit z2 = new Dragoon();
        ProtossUnit z3 = new Darktempler();
